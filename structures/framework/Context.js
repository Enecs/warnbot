...
module.exports = class Context {
  constructor(options) {
    ...
    this.guildDb = options.guildDb;

    this.member = this.interaction.member;
    this.guild = this.member.guild;
    this.author = this.interaction.user;
    this.channel = this.guild.channels.cache.get(this.interaction.channelId) || {id: this.interaction.channelId};
    this.args = this.interaction.options;
  ...
  async sendMsg(content = null, options = {}) {
    ...
    else if(this.interaction.replied || this.interaction.deferred) msg = await this.interaction.editReply(newOptions);
    else msg = await this.interaction.reply(newOptions);
