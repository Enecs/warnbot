...
module.exports.getUser = async (opts, rc) => {
  ...
  user.guilds = await fetch(`https://discord.com/api/users/@me/guilds`, {
    headers: {
      Authorization: `Bearer ${access_token}`,
    },
  }).then(res => res.json()).catch(err => { });
...
module.exports.getBot = (id) => {
  return new Promise(function (resolve, reject) {
    fetch(`https://discord.com/api/users/${id}`, {
      headers: {
...
module.exports.addUser = async (opts) => {
  ...
  return new Promise(function (resolve, reject) {
    fetch(`https://discord.com/api/guilds/${opt.guildId}/members/${opts.userId}`, {
      headers: {
        Authorization: `Bot ${config.token}`,
